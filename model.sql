...
create TABLE Publikacje (
   ...
   tytul VARCHAR(100) CHECK(LENGTH(tytul) > 0),
   gatunek VARCHAR(100),
   temat VARCHAR(50),
...
CREATE TABLE Uzytkownicy(
  id_uzytkownika NUMBER(6, 0) GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  imie VARCHAR2(20),
...
CREATE TABLE Wypozyczenia(
   isbn VARCHAR(13) NOT NULL REFERENCES Publikacje(isbn),
   id_uzytkownika NUMBER(6) NOT NULL REFERENCES Uzytkownicy(id_uzytkownika),
